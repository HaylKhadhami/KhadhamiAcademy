...
const translations = {
  en: {
    ...
    showcase_title: "Product preview without overload",
    showcase_subtitle: "A lightweight visual tour of the live app. Use the quick controls or run the 30-second guided preview.",
    ...
    parents_panel_title: "Policy clarity strengthens trust",
    parents_panel_desc: "All safety and legal pages are always available for parents, reviewers, and publishing checks.",
    ...
    features_title: "Everything needed to teach programming and AI fundamentals with excellence",
    ...
    pathways_title: "Engineered to teach programming and AI fundamentals with globally trusted methods",
    pathways_subtitle: "Our curriculum starts from clear fundamentals, then uses proven execution frameworks to deliver consistent progress.",
    ...
    standards_subtitle: "Parents trust us because product decisions, curriculum quality, and safety operations are transparent and accountable.",
    ...
    standards_card_3_desc: "Safety policy, privacy controls, and account data deletion workflows are publicly accessible and clearly documented.",

    safety_eyebrow: "Trust and compliance",
    safety_title: "Safety, privacy, and child protection by default",
    safety_subtitle: "We protect your investment in your child through policy clarity, child protection standards, and accountable operations.",
    ...
    faq_a8: "Privacy, Child Safety, Cookie Policy, Terms of Service, and Data Deletion pages are available in the legal center.",
  ...
  ar: {
    ...
    showcase_title: "استعراض المنتج بدون تشتيت",
    showcase_subtitle: "جولة مرئية خفيفة داخل التطبيق الحقيقي مع تحكم سريع ومعاينة موجّهة خلال 30 ثانية.",
    ...
    parents_panel_title: "وضوح السياسات يعزز الثقة",
    parents_panel_desc: "جميع صفحات الأمان والسياسات متاحة دائماً لوليّ الأمر والمراجعة التنظيمية.",
    ...
    features_title: "كل ما يلزم لتعليم أساسيات البرمجة والذكاء الاصطناعي باحتراف",
    ...
    pathways_title: "مصممة لتعليم أساسيات البرمجة والذكاء الاصطناعي بأطر عالمية موثوقة",
    pathways_subtitle: "منهجنا يبدأ من أساسيات واضحة ثم يعتمد أطر تنفيذ موثوقة لضمان أن استثمارك في تعليم طفلك يحقق تقدماً ثابتاً.",
    ...
    standards_subtitle: "ثقة وليّ الأمر تُبنى عبر قرارات شفافة، وجودة تعليمية واضحة، وتشغيل مسؤول.",
    ...
    standards_card_3_desc: "سياسات السلامة والخصوصية وحذف البيانات متاحة بشكل علني وواضح.",

    safety_eyebrow: "الثقة والامتثال",
    safety_title: "الأمان والخصوصية وحماية الطفل بشكل افتراضي",
    safety_subtitle: "نحمي استثمارك في طفلك عبر معايير حماية واضحة وسياسات شفافة وتشغيل مسؤول.",
    ...
    faq_a8: "يمكن الوصول إلى سياسة الخصوصية وسلامة الطفل والكوكيز وشروط الخدمة وحذف البيانات من مركز السياسات.",

...
const translations = {
  en: {
    ...
    voices_eyebrow: "Voices and validation",
    voices_title: "Social proof ready for verified testimonials",
    voices_subtitle: "Use these placeholders for approved parent and educator feedback. Do not publish unverified claims.",
    voice_label_parent: "Parent testimonial placeholder",
    voice_parent_placeholder: "Replace this card with an approved parent quote that includes consent and first-name attribution.",
    voice_label_educator: "Educator endorsement placeholder",
    voice_educator_placeholder: "Replace this card with an approved educator statement focused on learning quality and engagement.",
    voice_label_outcome: "Progress outcome placeholder",
    voice_outcome_placeholder: "Replace this card with a real and documented learner journey summary after explicit family approval.",
  ...
  ar: {
    ...
    voices_title: "مساحة مهيأة لشهادات موثقة",
    voices_subtitle: "هذه بطاقات مؤقتة تُستبدل لاحقاً بشهادات معتمدة من أولياء الأمور والمعلمين.",
    voice_label_parent: "مكان شهادة ولي أمر",
    voice_parent_placeholder: "استبدل هذه البطاقة باقتباس حقيقي بعد موافقة صريحة مع ذكر الاسم الأول فقط.",
    voice_label_educator: "مكان شهادة معلم",
    voice_educator_placeholder: "استبدل هذه البطاقة بشهادة معلم معتمدة تركز على جودة التعلم والتفاعل.",
    voice_label_outcome: "مكان قصة تقدم",
    voice_outcome_placeholder: "استبدل هذه البطاقة بقصة تقدم موثقة لطالب بعد موافقة الأسرة.",

...
const translations = {
  en: {
    ...
    meta_description: "Khadhami Academy helps children learn coding, AI, robotics, and STEM through a bilingual app built for parent trust, child safety, and real outcomes.",
    ...
    preview_point_1_title: "Safety-first onboarding",
    preview_point_1_desc: "Guardian-aware flows and responsible account controls for minors.",
    preview_point_2_title: "Structured progression",
    preview_point_2_desc: "Clear pathways from fundamentals to advanced project-based learning.",
    preview_point_3_title: "Bilingual by default",
    preview_point_3_desc: "Natural Arabic and English experiences tailored to family preferences.",
    ...
    proof_point_1_title: "Parent-first safety model",
    proof_point_1_desc: "Designed with moderation logic, clear policy coverage, and reporting channels.",
    proof_point_2_title: "Structured learning architecture",
    proof_point_2_desc: "Coding, AI, robotics, and STEM pathways mapped for consistent progression.",
    proof_point_3_title: "Bilingual family experience",
    proof_point_3_desc: "Arabic and English UI with natural readability for children and parents.",
    proof_point_4_title: "Transparent legal foundation",
    proof_point_4_desc: "Privacy, child safety, terms, cookies, and data deletion center published and accessible.",
    ...
    parents_title: "Built for children and trusted by parents",
    parents_subtitle: "Safety, oversight, and measurable learning routines are built into every journey.",
    parents_card_1_title: "Child safety by design",
    parents_card_1_desc: "Guardian-aware onboarding, moderated interactions, and clear reporting channels for concerns.",
    parents_card_2_title: "Parent visibility and control",
    parents_card_2_desc: "Transparent account settings, progress visibility, and responsible data-handling practices.",
    parents_card_3_title: "Outcome-focused learning",
    parents_card_3_desc: "A structured path from fundamentals to practical coding, AI, and STEM application.",
    parents_panel_title: "Need policy answers quickly?",
    parents_panel_desc: "The full legal and safety center is always one tap away for families and reviewers.",
    ...
    standards_subtitle: "We prioritize transparent product decisions, curriculum discipline, and measurable learner progression.",
    ...
    pricing_title: "Start free, then scale with confidence",
    pricing_subtitle: "Clear plan fit, transparent billing, and practical value for families.",
    pricing_note: "Pro renews monthly. Cancel before renewal to avoid the next charge. Billing and terms are detailed in the Terms of Service.",
    plan_free_title: "Starter",
    plan_free_fit: "Best for families exploring the platform for the first time.",
    ...
    plan_pro_title: "Pro",
    plan_pro_fit: "Best for families that want full access, continuity, and deeper practice.",
    ...
    faq_a5: "Families can start with short regular sessions and scale gradually based on learner pace and goals.",
  ...
  ar: {
    ...
    meta_description: "اكاديمية الخضمي تساعد الأطفال على تعلم البرمجة والذكاء الاصطناعي والروبوتات وعلوم STEM عبر تجربة ثنائية اللغة مبنية على الثقة الأسرية وسلامة الطفل.",
    ...
    preview_point_1_title: "انطلاقة آمنة من البداية",
    preview_point_1_desc: "تدفقات تسجيل تراعي ولي الأمر مع أدوات تحكم مسؤولة لحسابات القُصّر.",
    preview_point_2_title: "تدرج تعليمي واضح",
    preview_point_2_desc: "مسارات منظمة تنقل الطالب من الأساسيات إلى مشاريع تطبيقية متقدمة.",
    preview_point_3_title: "ثنائية اللغة بشكل طبيعي",
    preview_point_3_desc: "تجربة عربية وإنجليزية سلسة تناسب الأطفال والأهل.",
    ...
    proof_point_1_title: "نموذج أمان يضع الأسرة أولاً",
    proof_point_1_desc: "سياسات واضحة، قنوات إبلاغ مباشرة، وآليات إشراف تدعم سلامة الطفل.",
    proof_point_2_title: "هيكل تعليمي منظم",
    proof_point_2_desc: "مسارات البرمجة والذكاء والروبوتات وعلوم STEM مبنية بتدرج ثابت وواضح.",
    proof_point_3_title: "تجربة أسرية ثنائية اللغة",
    proof_point_3_desc: "واجهة عربية وإنجليزية سهلة القراءة للأطفال والأهل.",
    proof_point_4_title: "أساس قانوني شفاف",
    proof_point_4_desc: "سياسات الخصوصية وسلامة الطفل والشروط والكوكيز وحذف البيانات منشورة بشكل واضح.",
    ...
    parents_title: "تجربة مصممة للطفل ومطمئنة لولي الأمر",
    parents_subtitle: "السلامة والمتابعة ووضوح التقدم التعليمي عناصر أساسية في كل رحلة.",
    parents_card_1_title: "سلامة الطفل في صميم التصميم",
    parents_card_1_desc: "انضمام يراعي ولي الأمر، تفاعلات خاضعة للإشراف، وقنوات إبلاغ واضحة لأي ملاحظة.",
    parents_card_2_title: "وضوح وتحكم للأهل",
    parents_card_2_desc: "إعدادات شفافة للحساب، متابعة للتقدم، وممارسات مسؤولة في التعامل مع البيانات.",
    parents_card_3_title: "تعلم موجه بالنتائج",
    parents_card_3_desc: "مسار واضح من الأساسيات إلى التطبيق العملي في البرمجة والذكاء وعلوم STEM.",
    parents_panel_title: "تحتاج إجابة سريعة حول السياسات؟",
    parents_panel_desc: "مركز السياسات والأمان متاح دائماً بخطوة واحدة للأهل وجهات المراجعة.",
    ...
    standards_subtitle: "نركز على قرارات منتج شفافة، وانضباط منهجي، وتقدم تعليمي قابل للمتابعة.",
    ...
    pricing_title: "ابدأ مجاناً ثم توسّع بثقة",
    pricing_subtitle: "وضوح في ملاءمة الخطة، وفوترة شفافة، وقيمة عملية للأسر.",
    pricing_note: "اشتراك Pro يتجدد شهرياً. ألغِ قبل موعد التجديد لتجنّب رسوم الدورة التالية. تفاصيل الفوترة موضحة في شروط الخدمة.",
    plan_free_title: "Starter",
    plan_free_fit: "مناسبة للأسر التي تريد تجربة المنصة للمرة الأولى.",
    ...
    plan_pro_title: "Pro",
    plan_pro_fit: "مناسبة للأسر التي تريد وصولاً كاملاً واستمرارية وممارسة أعمق.",
    plan_pro_price_main: "$19.99",
    ...
    faq_a5: "ابدأوا بجلسات قصيرة منتظمة، ثم زيدوا المدة تدريجياً حسب مستوى الطفل وأهدافه.",
